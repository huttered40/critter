...
struct nonblocking_info{
  nonblocking_info(){}
  nonblocking_info(bool _is_sender, int _partner, MPI_Comm _comm, float _nbytes, float _comm_size, nonblocking* _track){
