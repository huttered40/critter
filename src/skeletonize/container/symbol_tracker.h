#ifndef CRITTER__SKELETONIZE__CONTAINER__SYMBOL_TRACKER_H_
#define CRITTER__SKELETONIZE__CONTAINER__SYMBOL_TRACKER_H_
...
#endif /*CRITTER__SKELETONIZE__CONTAINER__SYMBOL_TRACKER_H_*/
