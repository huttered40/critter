#ifndef CRITTER__SKELETONIZATION__CONTAINER__SYMBOL_TRACKER_H_
#define CRITTER__SKELETONIZATION__CONTAINER__SYMBOL_TRACKER_H_
...
#endif /*CRITTER__SKELETONIZATION__CONTAINER__SYMBOL_TRACKER_H_*/
