...
class ftimer{
  public:
    ...
    std::string name;
    double start_time,start_excl_time;
    double* acc_time,*acc_excl_time,*acc_calls;
    int active_counter;
};
...
extern std::array<double,3*max_num_symbols> symbol_timer_pad;
