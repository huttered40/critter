...
std::map<comm_pattern_key,pattern_key_id,comm_key_compare> comm_pattern_map;
std::map<comp_pattern_key,pattern_key_id,comp_key_compare> comp_pattern_map;
