...
#endif
#endif
    complete_comp(_BLAS_axpy__id,flops,n);
  } else{
#ifdef MKL
#ifdef CBLAS
...
#endif
#endif
    complete_comp(_BLAS_scal__id,flops,n);
  } else{
#ifdef MKL
#ifdef CBLAS
...
#endif
#endif
    complete_comp(_BLAS_ger__id,flops,m,n);
  } else{
#ifdef MKL
#ifdef CBLAS
...
#endif
#endif
    complete_comp(_BLAS_gemm__id,flops,m,n,k);
  } else{
#ifdef MKL
#ifdef CBLAS
...
#endif
#endif
    complete_comp(_BLAS_trmm__id,flops,m,n);
  } else{
#ifdef MKL
#ifdef CBLAS
...
#endif
#endif
    complete_comp(_BLAS_trsm__id,flops,m,n);
  } else{
#ifdef MKL
#ifdef CBLAS
...
#endif
#endif
    complete_comp(_BLAS_syrk__id,flops,n,k);
  } else{
#ifdef MKL
#ifdef CBLAS
...
#endif
#endif
    complete_comp(_LAPACK_getrf__id,flops,m,n);
  } else{
#ifdef MKL
#ifdef LAPACKE
...
#endif
#endif
    complete_comp(_LAPACK_potrf__id,flops,n);
  } else{
#ifdef MKL
#ifdef LAPACKE
...
#endif
#endif
    complete_comp(_LAPACK_trtri__id,flops,n);
  } else{
#ifdef MKL
#ifdef LAPACKE
...
#endif
#endif
    complete_comp(_LAPACK_geqrf__id,flops,m,n);
  } else{
#ifdef MKL
#ifdef LAPACKE
...
#endif
#endif
    complete_comp(_LAPACK_orgqr__id,flops,m,n,k);
  } else{
#ifdef MKL
#ifdef LAPACKE
...
#endif
#endif
    complete_comp(_LAPACK_ormqr__id,flops,m,n,k);
  } else{
#ifdef MKL
#ifdef LAPACKE
...
#endif
#endif
    complete_comp(_LAPACK_getri__id,flops,n);
  } else{
#ifdef MKL
#ifdef LAPACKE
...
#endif
#endif
    complete_comp(_LAPACK_tpqrt__id,flops,m,n,l,nb);
  } else{
#ifdef MKL
#ifdef LAPACKE
...
#endif
#endif
    complete_comp(_LAPACK_tpmqrt__id,flops,m,n,k,l,nb);
  } else{
#ifdef MKL
#ifdef LAPACKE
...
void _blk_to_cyc_rect_(double* blocked, double* cyclic, int num_rows_local, int num_columns_local, int sliceDim){
  if (mode){
    ...
    complete_comp(_CAPITAL_blktocyc__id,flops,num_rows_local,num_columns_local,sliceDim);
  } else{
    int write_idx = 0; int read_idx = 0;
    int offset = num_rows_local*num_columns_local;
    int num_rows_global = num_rows_local*sliceDim;
