#ifndef CRITTER__PROFILE__CONTAINER__SYMBOL_TRACKER_H_
#define CRITTER__PROFILE__CONTAINER__SYMBOL_TRACKER_H_
...
class symbol_tracker{
  public:
    ...
    std::vector<float*> cp_excl_measure;//TODO: Remove this? Seems redundant.
...
#endif /*CRITTER__PROFILE__CONTAINER__SYMBOL_TRACKER_H_*/
