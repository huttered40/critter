#ifndef CRITTER__PROFILE__CONTAINER__COMM_TRACKER_H_
#define CRITTER__PROFILE__CONTAINER__COMM_TRACKER_H_
...
#endif /*CRITTER__PROFILE__CONTAINER__COMM_TRACKER_H_*/
