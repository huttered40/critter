...
size_t path_pattern_comm_count;
size_t path_pattern_comp_count;
size_t path_pattern_comm_op;
size_t path_pattern_comp_op;
size_t path_pattern_comm_scale;
size_t path_pattern_comp_scale;
...
std::map<comm_pattern_param1_key,comm_pattern_param2_val> comm_pattern_cache_param2;
std::map<comp_pattern_param1_key,comp_pattern_param1_val> comp_pattern_cache_param1;
std::map<comp_pattern_param1_key,comp_pattern_param2_val> comp_pattern_cache_param2;
