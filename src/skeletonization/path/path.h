...
public:
  ...
  static void complete_comm(MPI_Request* request, MPI_Status* status);
  static void complete_comm(int count, MPI_Request array_of_requests[], int* indx, MPI_Status* status);
  static void complete_comm(int incount, MPI_Request array_of_requests[], int* outcount, int array_of_indices[], MPI_Status array_of_statuses[]);
  static void complete_comm(int count, MPI_Request array_of_requests[], MPI_Status array_of_statuses[]);
