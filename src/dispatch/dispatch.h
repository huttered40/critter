...
void complete_comp(double errtime, std::vector<intptr_t>& user_array, size_t id, double flop_count, int param1=-1, int param2=-1, int param3=-1, int param4=-1, int param5=-1);
