...
bool initiate_comm(size_t id, volatile double curtime, volatile double itime, int64_t nelem,
  ...
  switch (mechanism){
    ...
    case 1:
      ...
      break;
    case 2:
      schedule_decision = skeletonization::path::initiate_comm(*(skeletonization::nonblocking*)skeletonization::list[id],curtime,itime,nelem,t,cm,request,is_sender,partner);
      break;
  }
  return schedule_decision;
}
...
void complete_comm(double curtime, MPI_Request* request, MPI_Status* status){
  switch (mechanism){
    ...
    case 1:
      ...
      break;
    case 2:
      skeletonization::path::complete_comm(curtime,request,status);
      break;
  }
}
...
void complete_comm(double curtime, int count, MPI_Request array_of_requests[], int* indx, MPI_Status* status){
  switch (mechanism){
    ...
    case 1:
      ...
      break;
    case 2:
      skeletonization::path::complete_comm(curtime,count,array_of_requests,indx,status);
      break;
  }
}
...
void complete_comm(double curtime, int incount, MPI_Request array_of_requests[], int* outcount, int array_of_indices[], MPI_Status array_of_statuses[]){
  switch (mechanism){
    ...
    case 1:
      ...
      break;
    case 2:
      skeletonization::path::complete_comm(curtime,incount,array_of_requests,outcount,array_of_indices,array_of_statuses);
      break;
  }
}
...
void complete_comm(double curtime, int count, MPI_Request array_of_requests[], MPI_Status array_of_statuses[]){
  switch (mechanism){
    ...
    case 1:
      ...
      break;
    case 2:
      skeletonization::path::complete_comm(curtime,count,array_of_requests,array_of_statuses);
      break;
  }
}
