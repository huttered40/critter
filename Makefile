...
bin/test_gather: lib/libcritter.a bmark/test_gather.cxx
	$(CXX) bmark/test_gather.cxx -o bin/test_gather $(CXXFLAGS) -L./lib -lcritter $(LDFLAGS)
...
bin/test_reducescatter: lib/libcritter.a bmark/test_reducescatter.cxx
	$(CXX) bmark/test_reducescatter.cxx -o bin/test_reducescatter $(CXXFLAGS) -L./lib -lcritter $(LDFLAGS)
bin/test_scatter: lib/libcritter.a bmark/test_scatter.cxx
	$(CXX) bmark/test_scatter.cxx -o bin/test_scatter $(CXXFLAGS) -L./lib -lcritter $(LDFLAGS)
...
bin/test_alltoall: lib/libcritter.a bmark/test_alltoall.cxx
	$(CXX) bmark/test_alltoall.cxx -o bin/test_alltoall $(CXXFLAGS) -L./lib -lcritter $(LDFLAGS)
